...
The notebook `binary_classifier.ipynb` attempts to reproduce results from the original paper, making use of the `gai_cal.py` script provided to compute the "Gut Age Index" proposed in [the original paper](https://www.nature.com/articles/s41598-024-82418-3).
